...
namespace L3DPP
{
                                    ...
                                    const unsigned int max_iter_CERES)
    {
        ...
        global2local_.clear();   // comment out: "double free" test - 10/29/23

        local2global_.clear();   // comment out: "double free" test - 10/29/23
    ...
    void Line3D::clusterSegments()
    {
        ...
        // double free - 10.29/2023
        if (u != nullptr){
            std::cout << "delete u empty" << std::endl;
            delete u;
        }
