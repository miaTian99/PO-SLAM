/**
 * Description : Redis + orbslam2_单目执行程序脚本
 * Date :  26/06/2023
 * Author : Mia Tien
 * Modified : 16/08/2023
**/
...
void call_back(std::string channel, std::string msg)
{
    if (channel=="offline_bbox")
    {
        ...
        //cv::waitKey(1);
        // 存储收到的数据，若文件不存在则创建文件
        string rootdir = "/home/ai-i-tianyaolin/workspace/EAO-SLAM-v1/dataset/SMT/" + seq_name;
        string mask_save_path = rootdir + "/sam_mask";
        string bbox_save_path = rootdir + "/matching_bboxes";
