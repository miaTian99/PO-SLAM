...
int main(int argc, char **argv)
{
    if(argc != 5)
    {
        cerr << endl << "Usage: ./mono_tum option path_to_sequence path_to_vocabulary path_to_settings" << endl;
        // ./Examples/Monocular/mono_tum Full /media/wu/A/A-Study/Datasets/tum/rgbd_dataset_freiburg3_long_office_household/ Vocabulary/ORBvoc.bin Examples/Monocular/TUM3.yaml
        return 1;
    }
    ...
    for(int ni=0; ni<nImages; ni++)
    {
        ...
        cout << endl << endl;
        cout << "Image " << ni << "will be handled" << endl;
...
void LoadImages(const string &strFile, vector<string> &vstrImageFilenames, vector<double> &vTimestamps)
{
    ...
    while(!f.eof())
    {
        ...
        if(!s.empty())
        {
            ...
            cout << "=====================" << endl;
            cout << "check timestamp at each frame: " << to_string(t) << endl;
        }
    }
}
