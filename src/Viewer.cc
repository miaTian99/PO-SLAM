...
void Viewer::Run()
{
    ...
    pangolin::Var<bool> menuShowCubeObj("menu.Show CubeObj",true,true); // 显示立方体true,true；不显示false,false
...
//            .SetBounds(0.0, 1.0, pangolin::Attach::Pix(175), 1.0, -1024.0f/768.0f)
    ...
    cv::moveWindow("Point, Line and Object Detection", 40, 737);
    cv::namedWindow("Quadric Projection");
    cv::moveWindow("Quadric Projection", 40, 1554);
...
//            s_cam.SetModelViewMatrix(pangolin::ModelViewLookAt(mViewpointX,mViewpointY,mViewpointZ, 0,0,0,0.0,-1.0, 0.0));
        ...
        {
            cv::Mat resizeimg;
            cv::resize(im, resizeimg, cv::Size(1024*0.9, 1024*0.9), 0, 0, cv::INTER_CUBIC);
            // resizeimg =im.clone();
        ...
        {
            cv::Mat resizeimg;
            cv::resize(RawImage, resizeimg, cv::Size(1024*0.9, 1024*0.9), 0, 0, cv::INTER_CUBIC);
        ...
        {
            cv::Mat resizeimg;
            cv::resize(QuadricImage, resizeimg, cv::Size(1024*0.9, 1024*0.9), 0, 0, cv::INTER_CUBIC);
